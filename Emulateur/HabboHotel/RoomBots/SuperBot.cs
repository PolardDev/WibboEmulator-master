...
namespace Butterfly.HabboHotel.RoomBots
{
    public class SuperBot : BotAI
    {
        ...
        public SuperBot(int VirtualId)
        {
            ...
            this.SpeechTimer = ButterflyEnvironment.GetRandomNumber(30, 120);
            this.ActionTimer = ButterflyEnvironment.GetRandomNumber(0, 60);
        }
        ...
        public override void OnTimerTick()
        {
            ...
            RoomUser OwnerUser = this.GetRoom().GetRoomUserManager().GetRoomUserByHabboId(this.GetBotData().OwnerId);
            if (OwnerUser == null)
            {
                //remove bot
