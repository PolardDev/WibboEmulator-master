// Type: Butterfly.HabboHotel.Rooms.DynamicRoomModel
...
namespace Butterfly.HabboHotel.Rooms
{
    public class DynamicRoomModel
    {
        ...
        private ServerPacket SerializeHeightmap()
        {
            ...
            Message.WriteBoolean(MurHeight > 0); //enable  hauteur du mur
            Message.WriteInteger((MurHeight > 0) ? MurHeight : -1); // numéro hauteur
