...
namespace Butterfly.Communication.Packets.Outgoing.Structure
{
    class GroupInfoComposer : ServerPacket
    {
            ...
            : base(ServerPacketHeader.GroupInfoMessageComposer)
        {
            ...
            WriteString((ButterflyEnvironment.GetGame().GetRoomManager().GenerateRoomData(Group.RoomId) == null) ? "No room found.." : ButterflyEnvironment.GetGame().GetRoomManager().GenerateRoomData(Group.RoomId).Name);    // room name
            ...
            WriteString(ButterflyEnvironment.GetUsernameById(Group.CreatorId));
